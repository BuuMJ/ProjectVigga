...
document.querySelector('.Users-show').style.cssText = "background-color: rgba(0, 150, 255,0.5)";
...
document.querySelector('.Users-show').style.cssText = "background-color: #0480FC";
